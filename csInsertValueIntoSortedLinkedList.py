...
need to look over the values in the list.  if the target is > than the current but less than the current.next, then insert after current. 

if current.next is greater > value, push value onto beginning
...
insertValueIntoSortedLinkedList({1,2,3,5,6,8},7)
